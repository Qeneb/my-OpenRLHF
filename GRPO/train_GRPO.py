...
from DataParallel_GRPO import train_with_grpo
from prepare_dataset import prepare_dataset
from reward_model import combined_reward
from evaluate_model import evaluate_model
from initialize import set_random_seed, check_and_set_wandb
...
# Initialize
set_random_seed(22)
check_and_set_wandb(project_name="GRPO-Qwen-1.5-Instruct-Multi-GPU")
...
size_of_eval_data = 5 # change to a smaller value to save time or to a larger number for a more reliable estimate
